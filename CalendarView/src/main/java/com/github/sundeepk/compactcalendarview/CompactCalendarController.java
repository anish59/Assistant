...
class CompactCalendarController {
    ...
    private void init(Context context) {
        ...
        borderPaint.setTypeface(Typeface.SANS_SERIF);
        borderPaint.setTextSize(textSize);
        borderPaint.setColor(calenderTextColor);
        borderPaint.getTextBounds("31", 0, "31".length(), textSizeRect);
...
//                    dayPaint.setStyle(Paint.Style.STROKE);
//                    canvas.drawPath(mPath, dayPaint);
//
//                    RectF temp = new RectF(0, textHeight, xPosition+(textHeight/2)+(textHeight/4), yPosition + (textHeight / 3));
//                    mPath.addRect(temp, Path.Direction.CCW);
//                    canvas.drawPath(mPath, dayPaint);
//                    // canvas.drawRect(temp,dayPaint);
